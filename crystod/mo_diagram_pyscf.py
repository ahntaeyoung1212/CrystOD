    ...
    def write_html(self, output_path):
        ...
        render_diagram_page(
            ...
            foot_html=(
                ...
                + " SCF engine: PySCF &mdash; if you use it in your "
                "research, please cite Q. Sun et al., J. Chem. Phys. 153, "
                "024109 (2020); Q. Sun et al., WIREs Comput. Mol. Sci. 8, "
                "e1340 (2018); Q. Sun, J. Comput. Chem. 36, 1664 (2015). "
                "Generated by CrystOD (crystod-mol --diagram --pyscf)."
            ),
        )
