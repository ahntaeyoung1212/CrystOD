...
- `crystod` — the main command: crystal-orbital / atomic-band irreducible representations from atomic orbitals, no mode flag needed. (redesigned in v0.3.0; the old `--salc` form still works)
...
## 1. IrReps (Irreducible Representations) of SALC (Symmetry-Adapted Linear Combination) for a Selected Element and Orbital (main command; no mode flag since v0.3.0)
...
## 2. Hybridization Analysis (main command since v0.3.0)
...
## 3. Phonon Irreducible Representations (`crystod-phonon --irreps` since v0.3.0)
...
## 4. Basis Functions (`crystod-group --basis` since v0.3.0)
...
## 5. Direct Products of Point-Group Irreps (`crystod-group --product` since v0.3.0)
...
## 6. Symmetry-Only Vibration Bases (`crystod-phonon --vibration` since v0.3.0)
...
## 7. Symmetry-Adapted Phonon Modulation (`crystod-phonon --modulation` since v0.3.0)
...
## 8. SALC Basis Visualization (v0.2.1; `crystod --visualize` since v0.3.0)
...
## 9. Star of k (v0.2.1; main-command info option; k-point labels supported since v0.3.0)
...
## 10. Coset Decomposition (v0.2.1; `crystod-group --coset` since v0.3.0)
...
## 12. Brillouin Zone Plot (v0.2.2; sectioned command `crystod-bz` since v0.3.0)
...
## 13. Phonon Eigenvector Visualization (v0.2.3; `crystod-phonon --vector` since v0.3.0)
...
## 14. Reducible-Representation Decomposition (v0.2.3; `crystod-group --decompose` since v0.3.0)
...
## 15. ADPs from an MD Trajectory (v0.2.3; sectioned command `crystod-md` since v0.3.0)
...
## 16. Element-Projected Phonon Fatbands (v0.2.3; `crystod-phonon --fatband` since v0.3.0)
...
## 17. Supercell Brillouin Zone (v0.2.3; merged into `crystod-bz` since v0.3.0)
...
## 19. Ligand-Field Splitting (v0.2.3; `crystod-group --ligand-field` since v0.3.0)
...
## 20. Symmetry-Adapted Spin Bases: Cluster Multipoles / SAMM (v0.2.3; sectioned command `crystod-mag` since v0.3.0)
