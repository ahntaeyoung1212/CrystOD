...
- Main Python dependencies:
  `phonopy`, `spglib`, `spgrep`, `irrep`, `irreptables`, `ase`, `seekpath`, `pymatgen`, `numpy`, `pandas`, `openpyxl`, `sympy`, `pyscf`
